const Card = ({ cards, handleWantToCOok }) => {
    ...
    return (
        ...
        <div className="w-[350px] text-left p-6 border-2 border-gray-500 rounded-2xl space-y-3 text-[#dfe0ecd8]">
            ...
            <div className="flex justify-between">
                ...
                <p className="mr-8"><i className="fa-solid fa-fire-flame-curved"></i> {calories}</p>
            </div>
